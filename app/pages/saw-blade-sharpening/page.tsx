...
export default function SawBladeSharpeningPage() {
    return (
        <div>
            ...
            <div className="py-20 px-4 md:px-12 max-w-[1440px] mx-auto">
                ...
                <div className="text-center">
                    <Link href="/pages/sharpening-services" className="font-black text-sm flex items-center gap-2 hover:text-leuco-purple justify-center">
