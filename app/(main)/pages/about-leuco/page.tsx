            ...
            <div className="bg-leuco-black py-24 px-4 md:px-12">
                <div className="max-w-[1440px] mx-auto">
                    ...
                    <p className="text-gray-300 text-xl font-medium max-w-2xl">
                        For over 70 years, LEUCO has been the world's leading manufacturer of precision tooling systems for the woodworking, furniture, and composite industries.
                    </p>
                </div>
            </div>
            ...
            <div className="py-20 px-4 md:px-12 max-w-[1440px] mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-20">
                    <div>
                        ...
                        <p className="text-gray-600 font-medium mb-4">
                            Founded in 1954 in Horb am Neckar, Germany, LEUCO has grown from a local tool manufacturer into a global precision tooling leader with operations across North America, Europe, and Asia.
                        </p>
                        <p className="text-gray-600 font-medium mb-4">
                ...
                <div className="mb-20">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                        {locations.map((loc, i) => (
                            <Link key={i} href={loc.href} className="group flex items-center gap-3 p-6 border border-gray-100 hover:border-leuco-purple/30 hover:shadow-lg transition-all">
                ...
                <div className="flex flex-wrap gap-4">
                    <Link href="/pages/leuco-careers" className="bg-leuco-purple text-white font-black px-8 py-4 inline-flex items-center gap-2 hover:bg-leuco-black transition-colors">
                        VIEW CAREERS <ArrowRight size={18} />
                    </Link>
                    <Link href="/pages/catalogs" className="border-2 border-leuco-black text-leuco-black font-black px-8 py-4 inline-flex items-center gap-2 hover:bg-leuco-black hover:text-white transition-colors">
