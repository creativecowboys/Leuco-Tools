                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
                            {locations.map((loc, i) => (
                                <Link key={i} href={loc.href} className="group p-6 border border-gray-100 hover:border-leuco-purple/30 hover:shadow-lg transition-all">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+18006310096" className="font-black hover:text-leuco-purple transition-colors">1-800-631-0096</a>
                                </div>
                            </div>
                            <div className="flex items-center gap-3">
