    ...
    return (
        <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {collections.map((col, i) => (
                        <motion.div key={i} whileHover={{ y: -6 }} className="group border border-gray-100 hover:border-leuco-purple/30 hover:shadow-xl transition-all duration-300">
                            <Link href={col.href} className="block p-10">
            ...
            <div className="bg-leuco-purple py-20 px-4 md:px-12 text-center">
                ...
                <Link href="/pages/custom-tooling" className="bg-white text-leuco-purple font-black px-10 py-4 inline-flex items-center gap-2 hover:bg-leuco-black hover:text-white transition-colors">
