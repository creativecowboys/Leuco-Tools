        ...
        <div>
            ...
            <div className="bg-gray-50 py-16 px-4 md:px-12">
                <div className="max-w-[1440px] mx-auto flex flex-wrap gap-4 justify-center">
                    <Link href="/pages/tool-resharpening-faq" className="font-black text-sm flex items-center gap-2 hover:text-leuco-purple border border-gray-200 px-6 py-3 hover:border-leuco-purple transition-colors">
                        Resharpening FAQ <ChevronRight size={14} />
                    </Link>
                    <Link href="/pages/saw-blade-sharpening" className="font-black text-sm flex items-center gap-2 hover:text-leuco-purple border border-gray-200 px-6 py-3 hover:border-leuco-purple transition-colors">
                        Saw Blade Sharpening <ChevronRight size={14} />
                    </Link>
                    <Link href="/pages/tool-sharpening" className="font-black text-sm flex items-center gap-2 hover:text-leuco-purple border border-gray-200 px-6 py-3 hover:border-leuco-purple transition-colors">
                        Tool Sharpening <ChevronRight size={14} />
                    </Link>
                    <Link href="/pages/carbide-saw-sharpening-tips-tricks" className="font-black text-sm flex items-center gap-2 hover:text-leuco-purple border border-gray-200 px-6 py-3 hover:border-leuco-purple transition-colors">
