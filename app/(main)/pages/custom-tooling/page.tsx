...
export const metadata: Metadata = {
    title: 'Custom Tooling - LEUCO Tool Corporation',
    description: 'LEUCO custom tooling solutions. Our engineers design application-specific cutting tools when standard tools cannot meet your requirements.',
};

export default function CustomToolingPage() {
    return (
        <div>
            ...
            <div className="py-20 px-4 md:px-12 max-w-[1440px] mx-auto">
                ...
                <div className="bg-leuco-purple p-12 text-center">
                    ...
                    <Link href="/pages/contact-leuco" className="bg-white text-leuco-purple font-black px-10 py-4 inline-flex items-center gap-2 hover:bg-leuco-black hover:text-white transition-colors">
