...
export default function CarbideSawTipsPage() {
    return (
        <div>
            ...
            <div className="py-20 px-4 md:px-12 max-w-[1440px] mx-auto">
                ...
                <div className="bg-leuco-black text-white p-12 flex flex-col md:flex-row items-center gap-8">
                    ...
                    <Link href="/pages/sharpening-services" className="bg-leuco-purple text-white font-black px-8 py-4 inline-flex items-center gap-2 hover:bg-white hover:text-leuco-purple transition-colors shrink-0">
