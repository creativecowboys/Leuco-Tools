    ...
    return (
        <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {services.map(({ title, desc, href, icon: Icon }, i) => (
                        <motion.div key={i} whileHover={{ y: -6 }} className="group">
                            <Link href={href} className="block p-10 border border-gray-100 hover:border-leuco-purple/30 hover:shadow-xl transition-all h-full">
            ...
            <div className="bg-gray-50 py-20 px-4 md:px-12 text-center">
                ...
                <Link href="/pages/contact-leuco" className="bg-leuco-purple text-white font-black px-10 py-4 inline-flex items-center gap-2 hover:bg-leuco-black transition-colors">
